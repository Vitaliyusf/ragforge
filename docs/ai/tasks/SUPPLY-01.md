# SUPPLY-01 — Supply-chain and artifact security gate

**Order:** 52  
**Phase:** 7 Distributed production  
**Priority:** P2  
**Branch:** `ci/supply-chain-hardening`  
**Depends on:** `DEPS-01`, `SEC-03`

## Goal
Add SBOM, reproducible artifact provenance and enforceable vulnerability policy for release images.
...
## Required behavior
- Generate SBOM per app image.
- Scan images/dependencies with staged severity policy.
- Pin release image versions/digests where practical.
- Attach source/build provenance.
- Document vulnerability exception/expiry process.
- Keep developer loop lighter than release gate.
