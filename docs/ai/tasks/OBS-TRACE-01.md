# OBS-TRACE-01 — Unify AI tracing on a vendor-neutral instrumentation layer

**Order:** 44  
**Phase:** 6 Quality & Observability  
**Priority:** P2  
**Branch:** `feat/otel-ai-tracing`  
**Depends on:** `LLM-CTRL-01`, `TRACE-01`

## Goal
Consolidate RAG/Embedding/LLM tracing wrappers behind vendor-neutral instrumentation with pluggable exporters.

## Primary scope
- `RAG/Embedding/LLM tracing`
- `shared trace/redaction policy`
- `exporter config`
- `privacy tests`

## Required behavior
- One shared policy owns context/redaction/exporter lifecycle.
- Business services define domain spans.
- Support no-op plus LangSmith and/or self-hosted Phoenix exporter.
- External content tracing disabled/redacted by default.
- No raw private documents/prompts by default.
...
**Task-specific refactor target:** Delete service-specific exporter wrappers after migration.

## Non-goals
- No business logic in tracing shared layer.
